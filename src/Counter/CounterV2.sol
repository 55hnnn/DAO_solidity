...
contract CounterV2 is UUPSUpgradeable, OwnableUpgradeable, ICounterV2 {
    ...
    function _authorizeUpgrade(address newImplementation) internal override onlyOwner {
        require(registeredUpgradeContracts[newImplementation] != 0, "This contract addr is not registered for upgrade");
        require(registeredUpgradeContracts[newImplementation] + 2 weeks < block.timestamp, "It will take two weeks for this contract to be applied.");
